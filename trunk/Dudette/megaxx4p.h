...
#define UART1_DOUBLE         U2X1
#define UART1_CTRL           UCSR1B
#define UART1_CTRL_DATA  ((1<<TXEN1) | (1<<RXEN1))
#define UART1_CTRL2          UCSR1C
#define UART1_CTRL2_DATA ( (1<<UCSZ11) | (1<<UCSZ10))
